                            ...
                            <div class="col-lg-8">
                                <div class="post-container">
                                    ...
                                    <div class="content-nav-fixed dark-bg scale_anim">
                                        <ul>
                                            <li>
                                                <a href="blog-single.php" class="ln"><i class="fal fa-long-arrow-left"></i><span>Prev <strong>- Post Title</strong></span></a>
                                            ...
                                            <li>
                                                <a href="blog-single.php" class="rn"><span >Next <strong>- Post Title</strong></span> <i class="fal fa-long-arrow-right"></i></a>
